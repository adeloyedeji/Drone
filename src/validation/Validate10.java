...
public class Validate10 {
    ...
    public static void inspect10(javax.swing.JRadioButton[] buttons, javax.swing.JFrame frame, String name, javax.swing.JTextField[] fields) {
        int id = 0;
        String e1 = "", e2 = "";
        ...
        String sql = "INSERT INTO component10 VALUES('"+id+"', '"+values[0]+"', '"+values[1]+"','"+values[2]+"', '"+values[3]+"',"
       ...
       String sql3 = "INSERT INTO causability VALUES('"+values[0]+"', '"+values[1]+"','"+values[2]+"', '"+values[3]+"',"
        ...
        String sql2 = "INSERT INTO softwares10 VALUES('"+id+"', '"+e1+"', '"+e2+"', '"+name+"')";
