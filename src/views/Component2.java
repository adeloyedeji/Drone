...
public class Component2 {
    ...
    static javax.swing.JTextField[] fields = new javax.swing.JTextField[13];
    static javax.swing.JRadioButton[] buttons = new javax.swing.JRadioButton[84];
    static javax.swing.ButtonGroup[] groups = new javax.swing.ButtonGroup[21];
    static javax.swing.JButton nextButton;
    
    public static javax.swing.JComponent component2(final javax.swing.JTabbedPane pane) {
        ...
        labels[3].setText("1");
        labels[4].setText("0");
        labels[5].setText("Do you have any of the following resources located on your network? Please add more");
        labels[6].setText("Web Servers");
        labels[7].setText("Mail Servers");
        labels[8].setText("DNS Servers");
        labels[9].setText("Databases");
        labels[10].setText("Application Servers");
        labels[11].setText("Test and Development Servers");
        labels[12].setText("Learning Management System (L.M.S)");
        labels[13].setText("Do you keep documentted list of your network hardware assets ? If yes, mention some:");
        labels[14].setText("Do you maintain (review and update) the hardware inventory list ? ");
